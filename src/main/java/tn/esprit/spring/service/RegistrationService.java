...
import tn.esprit.spring.entity.AppUserRole;
import tn.esprit.spring.entity.RegistrationRequest;
import tn.esprit.spring.security.EmailValidator;
import tn.esprit.spring.security.token.ConfirmationToken;
import tn.esprit.spring.security.token.ConfirmationTokenService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        if (isValidEmail) {
            ...
            String link = "http://localhost:8095/api/v1/registration/confirm?token=" + tokenForNewUser;
    ...
    private String buildEmail(String name, String link) {
        return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n" +
                ...
                "        \n" +
                "            <p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\">Hi " + name + ",</p><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> Thank you for registering. Please click on the below link to activate your account : <p>KinderGarten Admin</p> </p><blockquote style=\"Margin:0 0 20px 0;border-left:10px solid #b1b4b6;padding:15px 0 0.1px 15px;font-size:19px;line-height:25px\"><p style=\"Margin:0 0 20px 0;font-size:19px;line-height:25px;color:#0b0c0c\"> <a href=\"" + link + "\">Activate Now</a> </p></blockquote>\n Link will expire in 15 minutes. <p>See you soon</p>" +
                "        \n" +
                "      </td>\n" +
                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                "    </tr>\n" +
