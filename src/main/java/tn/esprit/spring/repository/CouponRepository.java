...
public interface CouponRepository extends CrudRepository<Coupon, Integer> {
	...
	@Query(value = "select count(c) from Coupon c where c.parent.id =:id_parent and c.event.id_event=:id_event")
	public Coupon CountCouponByEventAndParent(@Param("id_parent") int id_parent, @Param("id_event") int id_event);
