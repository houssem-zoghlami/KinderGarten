...
public interface EventRepository extends CrudRepository<Event, Integer> {
	...
	@Query("select e from Event e where e.eventActivity=:event_Activity")
	public List<Event> getAllEventByActivity(@Param("event_Activity") Event_Activity eventActivity);

	@Query("select e from Event e where e.eventFor=:event_for")
	public List<Event> getAllEventByFor(@Param("event_for") Event_for event_for);

	@Query("select e from Event e where e.stateEvent=:state_event")
